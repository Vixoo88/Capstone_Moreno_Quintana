"""
Django settings for sifa_site project.
...
SECRET_KEY = 'django-insecure-%u(vy$nz3%6hwl0-f^0pz9n_8w^+dn)kd#6hxl&_v**k8r(9er'
...
WSGI_APPLICATION = 'sifa_site.wsgi.application'
...
LANGUAGE_CODE = 'es-cl'
TIME_ZONE = 'America/Santiago'   # o la que corresponda
USE_TZ = True
...
STATIC_ROOT = BASE_DIR / 'staticfiles'   # para deploy (collectstatic)

# sifa_site/settings.py
LOGIN_URL = 'login'
...
# CSRF_TRUSTED_ORIGINS = ["https://Vixoo.pythonanywhere.com"]
